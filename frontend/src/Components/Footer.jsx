...
import ShalomLogo from '../Assets/Images/ShalomLogo.jpg';
...
function Footer() {
    return(
        <footer className='footer'>
            ...
            <div className="shalomLogo">
                <Pic src={ShalomLogo}/>
            </div>

            <div className="Contact">
                <p>
                    <strong>За контакт и Въпроси:</strong>
                </p>
                <div className="IG">
                    <a href="https://www.instagram.com/martooo.memes?igsh=MTZwdHZrcjI0bDczeQ==">
                        <button>
                ...
                <div className="Facebook">
                    <a href="https://www.facebook.com/martin.kazandjiev.3/">
                        <button>
                ...
                <div className="Discord" >
                    <a href="https://discord.gg/D8bnyuTTX2">
                        <button>
